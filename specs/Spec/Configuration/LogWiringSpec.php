 ...
 * Class LogWiringSpec
 *
 * @mixin \Yapeal\Configuration\LogWiring
 *
 ...
 */
class LogWiringSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType('Yapeal\Configuration\LogWiring');
    }
}
