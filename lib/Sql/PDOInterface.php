 ...
 *     cleaner examples for type hinting etc as the existing stubs are not as clear as could be.
 */
interface PDOInterface
{
    /**
     ...
     * you issued. If no rows were affected, <b>PDO::exec</b> returns 0. <b>PDO::exec<b> may return <b>false<b> or emits
     ...
     *
     * @return \PDOStatement|false <b>PDO::query</b> returns a PDOStatement object, or <b>PDO::exec</b> may return
