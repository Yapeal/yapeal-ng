...
CREATE TABLE "{schema}"."{table_prefix}charAttributes" (
...
CREATE TABLE "{schema}"."{table_prefix}charCertificates" (
    "certificateID" BIGINT(20) UNSIGNED NOT NULL,
    "ownerID"       BIGINT(20) UNSIGNED NOT NULL,
    PRIMARY KEY ("ownerID", "certificateID")
);
CREATE TABLE "{schema}"."{table_prefix}charCharacterSheet" (
...
CREATE TABLE "{schema}"."{table_prefix}charCorporationRoles" (
    "ownerID"  BIGINT(20) UNSIGNED NOT NULL,
    "roleID"   BIGINT(20) UNSIGNED NOT NULL,
    "roleName" CHAR(100)           NOT NULL,
    PRIMARY KEY ("ownerID", "roleID")
);
CREATE TABLE "{schema}"."{table_prefix}charCorporationRolesAtBase" LIKE "{schema}"."{table_prefix}charCorporationRoles";
CREATE TABLE "{schema}"."{table_prefix}charCorporationRolesAtHQ" LIKE "{schema}"."{table_prefix}charCorporationRoles";
CREATE TABLE "{schema}"."{table_prefix}charCorporationRolesAtOther" LIKE "{schema}"."{table_prefix}charCorporationRoles";
CREATE TABLE "{schema}"."{table_prefix}charCorporationTitles" (
    "ownerID"   BIGINT(20) UNSIGNED NOT NULL,
    "titleID"   BIGINT(20) UNSIGNED NOT NULL,
    "titleName" CHAR(100)           NOT NULL,
    PRIMARY KEY ("ownerID", "titleID")
);
CREATE TABLE "{schema}"."{table_prefix}charImplants" (
    "ownerID"  BIGINT(20) UNSIGNED NOT NULL,
    "typeID"   BIGINT(20) UNSIGNED NOT NULL,
    "typeName" CHAR(100)           NOT NULL,
    PRIMARY KEY ("ownerID", "typeID")
);
CREATE TABLE "{schema}"."{table_prefix}charJumpCloneImplants" (
...
CREATE TABLE "{schema}"."{table_prefix}charJumpClones" (
    "cloneName"   CHAR(100)           NOT NULL,
    "jumpCloneID" BIGINT(20) UNSIGNED NOT NULL,
...
CREATE TABLE "{schema}"."{table_prefix}charSkills" (
