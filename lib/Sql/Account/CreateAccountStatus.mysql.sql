...
CREATE TABLE "{schema}"."{table_prefix}accountAccountStatus" (
...
CREATE TABLE "{schema}"."{table_prefix}accountMultiCharacterTraining" (
    "ownerID"     BIGINT(20) UNSIGNED NOT NULL,
    "trainingEnd" DATETIME            NOT NULL,
    PRIMARY KEY ("ownerID", "trainingEnd")
);
CREATE TABLE "{schema}"."{table_prefix}accountOffers" (
