...
/**
 * Contains class UpcomingCalendarEvents.
 *
 * PHP version 7.0+
 *
 * LICENSE:
 ...
 */
class UpcomingCalendarEvents extends CharSection implements EveApiPreserverInterface
{
    use PreserverTrait;
    ...
    public function __construct()
    {
        $this->mask = 1048576;
        $this->preserveTos = [
            'preserveToUpcomingCalendarEvents'
        ];
    }
    /**
